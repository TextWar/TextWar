...
public class JsonConfig extends Config {
    ...
    public void save() throws FileNotFoundException {
        ...
        writer.println(JavaUtils.format(nowObject.toJSONString()));
    }
    ...
    public void remove(String key) throws IOException {
        String[] keys = key.split("\\.");
        keys = JavaUtils.getParentArray(keys);
    ...
    public void setObject(String key, Object obj) throws IOException {
        String[] keys = JavaUtils.getParentArray(key.split("\\."));
    ...
    private JSONObject getJSONObject(String[] keys,InputStream in) throws IOException{
        this.in = in;
        BufferedReader reader = JavaUtils.getReader(in);
